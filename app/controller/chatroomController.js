...
App.chatroom = sumeru.controller.create(function(env, session) {
	...
	var sendMessage = function() {
		var input = document.getElementById('inputMessage'), inputVal = input.value.trim();

		var inputName = document.getElementById('inputName'), inputValName = inputName.value.trim();
